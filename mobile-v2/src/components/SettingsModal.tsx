        ...
        <View style={styles.overlay}>
          ...
          <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
              <TouchableOpacity style={styles.item} onPress={() => { onClose(); setTimeout(() => setShowLegal('cgu'), 300); }}>
              ...
              <TouchableOpacity style={styles.item} onPress={() => { onClose(); setTimeout(() => setShowLegal('privacy'), 300); }}>
              ...
              <TouchableOpacity style={styles.item} onPress={() => { onClose(); setTimeout(() => setShowLegal('mentions'), 300); }}>
