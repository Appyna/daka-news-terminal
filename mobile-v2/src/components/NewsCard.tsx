...
const NewsCardComponent: React.FC<NewsCardProps> = ({ article, isFocused, onPress }) => {
  ...
  const handleShare = async (e: any) => {
    ...
    try {
      // Format: [Titre en français] | [SOURCE EN CAPS]
      // 
      // DAKA News · Israël, France, International : l'info à la minute
      // dakanews.com
      const shareMessage = `${article.title} | ${article.source.toUpperCase()}\n\nDAKA News · Israël, France, International : l'info à la minute\ndakanews.com`;
