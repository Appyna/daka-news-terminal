...
import { NewsItem, NewsColumn as NewsColumnType } from './types';
...
const App: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col" style={{ backgroundColor: COLORS.dark1 }}>
      ...
      {/* Bouton hamburger fixe à gauche au milieu de l'écran */}
      <button
      ...
      {/* Terminal News - Prend tout l'espace disponible */}
